...
const configurationValuesRulesDirectory = path.join(__dirname, '../data/configurationvalues');
...
const updateConfigValues = async context => {
    const configurationValuesFiles = await getFiles(context, configurationValuesRulesDirectory);
